    ...
    return (
      <div className="min-h-screen py-12">
        <div className="text-center mb-8 px-4">
          ...
          <h1 className="text-3xl font-black mb-1" style={{ color: '#f0eef8' }}>Love Type Test</h1>
          <p className="text-sm" style={{ color: '#505075' }}>Discover your unique romance style</p>
        </div>
        <QuestionCard
      ...
      <div className="space-y-4 mt-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="rounded-xl p-5" style={{ background: '#111120', border: '1px solid #2db8a020' }}>
            <h4 className="font-bold mb-3" style={{ color: '#2db8a0' }}>💪 Your Strengths</h4>
            <Paragraphs text={result.strength} />
          </div>
          <div className="rounded-xl p-5" style={{ background: '#111120', border: '1px solid #e0525220' }}>
            <h4 className="font-bold mb-3" style={{ color: '#e05252' }}>⚠️ Watch Out For</h4>
            <Paragraphs text={result.weakness} />
          </div>
        </div>
        <div className="rounded-xl p-5" style={{ background: '#111120', border: '1px solid #2db8a020' }}>
          <h4 className="font-bold mb-3" style={{ color: '#2db8a0' }}>💞 Your Best Matches</h4>
      ...
      <div className="min-h-screen py-12 px-4">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-sm" style={{ color: '#505075' }}>Love Type Analysis Result</p>
          </div>

          <div className="rounded-2xl p-6 mb-6"
            style={{ background: '#111120', border: '1px solid #e05c7f40' }}>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <button onClick={handleReset} className="px-6 py-3 text-sm font-medium transition-all"
              style={{ background: 'transparent', border: '1px solid #2a2a48', color: '#505075', borderRadius: '9999px' }}>
              Retake Test
            </button>
            <a href="/en/test" className="px-6 py-3 text-sm font-medium text-center transition-all"
