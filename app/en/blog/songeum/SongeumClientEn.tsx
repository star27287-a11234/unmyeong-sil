            ...
            {PALM_ITEMS.map(item => (
              <button key={item.id} onClick={() => scrollTo(item.id)}
                ...
                style={{
                  ...
                  background: item.color, border: '2px solid rgba(255,255,255,0.8)',
                  cursor: 'pointer', fontSize: '9px', fontWeight: '800', color: '#1a1a1a',
